...
```bash
$ git clone https://github.com/johnhaley81/twitter-feel.git <my-project-name>
$ cd <my-project-name>
```
 ...
 **TODO**
Add DevTools by following the [manual integration walkthrough](https://github.com/gaearon/redux-devtools/blob/master/docs/Walkthrough.md).
